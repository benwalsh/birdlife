...
def main() -> int:
    ...
    ap.add_argument("--illustrations", type=Path, default=here / "assets" / "illustrations",
                    help="Cutout directory (default: <pipeline>/assets/illustrations/)")
    ap.add_argument("--json", type=Path, default=here / "assets" / "illustrations" / "masks.json",
                    help="Where to write masks.json (the Rails app reads this directly)")
    ap.add_argument("--check", action="store_true",
                    help="Report counts and don't write")
    args = ap.parse_args()
