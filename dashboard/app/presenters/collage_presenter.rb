...
# directly in the panel's pixel space. Names are NOT drawn on the birds (like the
# upstream) — a single caption names the featured bird, and a tap swaps it
...
class CollagePresenter
  ...
  ILLUSTRATIONS_DIR = Rails.root.join('../pipeline/assets/illustrations')
  ...
  # perch). Matches upstream apt.js's FLY_PROB — flight is the occasional accent,
