...
# birdlife is the product; a profile is an *instance* (culfinbirds is instance #1). The active
...
# through which a downstream user gives birdlife their coordinates, prompts, sources, curated
...
class StationProfile
  ...
  class << self
    ...
    def dir
      @dir ||= (ENV['STATION_PROFILE'].presence ? Pathname.new(ENV['STATION_PROFILE']).expand_path : example_dir)
    end
