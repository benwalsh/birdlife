...
# public *.ecs.<region>.on.aws endpoint. CloudFront still fronts it for culfinbirds.net
...
# (culfinbirds.ecs...on.aws), but AWS assigns a RANDOM-suffixed ingress endpoint
