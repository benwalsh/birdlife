# Route53 zone for the domain. If you registered culfinbirds.net elsewhere, point
...
resource "aws_acm_certificate_validation" "cf" {
  ...
  # `dig +short NS culfinbirds.net` and re-apply.
  timeouts {
    create = "10m"
  }
}
...
resource "aws_cloudfront_distribution" "main" {
  ...
  comment         = "culfinbirds.net public mirror"
