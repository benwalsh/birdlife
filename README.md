...
Every station is different, so birdlife is **configured, not forked**. Your place,
...
nothing unsourced ships). Keep them and your station will feel like birdlife.
...
Detection is Cornell's [BirdNET](https://birdnet.cornell.edu/); the project began as a
fork of [AvianVisitors](https://github.com/Twarner491/AvianVisitors) (built on
BirdNET-Pi) and has since diverged substantially (the PHP web layer became this Rails
app; detection was rebuilt around a station-profile model).

Licensed **CC BY-NC-SA 4.0** — this is **non-commercial** and **share-alike**, inherited
from BirdNET/BirdNET-Pi and binding as long as the project ships BirdNET. You may run,
study, and adapt it freely for non-commercial use; adaptations must share alike. It is
source-available on those terms, not an OSI "open source" licence.
